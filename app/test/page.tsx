      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            Effortless coding, seamless deployment. Focus on building, we handle the rest.
            </p>
          </motion.div>

          <motion.div variants={buttonVariants} className="mt-8">
            <motion.button
              className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-rose-500 rounded-full text-white font-medium shadow-lg hover:shadow-indigo-500/25 hover:shadow-xl transition-all duration-300"
